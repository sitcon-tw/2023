...
<!--        </div>-->
<!--      </div>-->
<!--      &lt;!&ndash; room decoration-line &ndash;&gt;-->
...
<!--            &lt;!&ndash; <btn v-if="activeSession.record || activeSession.live" :href="activeSession.record || activeSession.live">-->
<!--              {{  activeSession.record ? '錄影' : '直播'  }}連結</btn> &ndash;&gt;-->
<!--          </div>-->
